  ...
  return (
    <Container sx={{ textAlign: "center", backgroundColor: "#f7f7f7" }}>
      <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", gap: 1 }}>
        ...
        <Typography sx={{ fontWeight: "bold", fontSize: { sm: "16px", md: "28px", lg: "38px" } }}>
          Unlock Your Creative Potential
        </Typography>
      </Box>
      <Typography sx={{ mb: 2, fontSize: { sm: "16px", md: "18px", lg: "28px" } }}>
        with Online Design and Development Courses.
      </Typography>
      <Typography color="textSecondary" sx={{ fontSize: { sm: "14px", md: "16px", lg: "16px" } }} gutterBottom>
...
const ImageGrid = ({ images }) => (
  <Grid
    ...
    sx={{ marginTop: 10, marginBottom: 8, backgroundColor: "white", borderRadius: 2 }}
  >
    {images.map((img, index) => (
      <Grid item key={index}>
        <div className="image-wrapper">
          <Image src={img.src} width={140} height={140} alt={img.alt} priority={img.priority} />
        </div>
      </Grid>
    ))}
  </Grid>
